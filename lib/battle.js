...
BattleState.prototype.create = function() {
  ...
  this.sidebar.beginFill(0x073642);
  this.sidebar.drawRect(10, 5, offset-20, 488 - 20);
  this.sidebar.endFill();
  // 14 char max
  this.infoText = phaserGame.add.text(60, 50, '', {font: 'Ubuntu', fontSize: 16, fill: '#ffffff', textAlign: 'center'});
...
BattleState.prototype.setInfoText = function(text, dontClear) {
  ...
  if(!dontClear) {
    ...
    this._infoTextTimeout = setTimeout(this.setInfoText.bind(this, ''), 5000);
  }
};
